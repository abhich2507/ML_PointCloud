...
@jit(nopython=True)
def convert_pos(cub_idx, cell_idx, size=(100, 100, 100)):
    """
    ...
    new_z = int(z_cell // (400 // size[2])) ## 400 / 100 = 4 , it is required to scale the z axis to 50.
...
def process_events_in_range(index):
    ...
    file= ROOT.TFile.Open(f"/mnt/d/Pion_50GeV_Col/result_pion_{t}.root")
    ...
    with open(f"/mnt/c/Users/hnayak/Documents/PKL_pion_50GeV_50/pion{t}.pkl", "wb") as f:
