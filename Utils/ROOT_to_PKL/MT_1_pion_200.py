...
def convert_pos(cub_idx, cell_idx, size=(100, 100, 200)):
    ...
    new_z = int(z_cell // (200 // size[2])) ## 200 / 200 = 1 , it is required to scale the z axis to 200.
...
def process_events_in_range(index):
   ...
   # file = ROOT.TFile.Open(f"/mnt/c/Users/hnayak/Documents/Pion_100GeV_Col/result_pion_{t}.root")
    ...
    with open(f"/mnt/c/Users/hnayak/Documents/PKL_pion_50GeV_200/pion{t}.pkl", "wb") as f:
