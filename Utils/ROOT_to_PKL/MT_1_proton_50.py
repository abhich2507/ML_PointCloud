...
def process_events_in_range(index):
    ...
    with open(f"/mnt/c/Users/hnayak/Documents/PKL_proton_50GeV_50/proton{t}.pkl", "wb") as f:
        pickle.dump(df_events, f)

    print(f"proton{t}.pkl created")
    
    # root_file_path = f"/mnt/c/Users/hnayak/Documents/Proton_100Gev_Col/result_proton_{t}.root"
